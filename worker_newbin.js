...
export default {
  async fetch(request, env) {
    ...
    if (path === '/db/get') {
      ...
      const res = await fetch(`https://api.jsonbin.io/v3/b/6a1bd4f9ddf5aa59f77ac4a5/latest`, {
    ...
    if (path === '/db/put' && request.method === 'PUT') {
      ...
      const res = await fetch(`https://api.jsonbin.io/v3/b/6a1bd4f9ddf5aa59f77ac4a5`, {
        method: 'PUT',
        headers: {
